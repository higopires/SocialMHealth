...
public class ChangeBehaviorListener implements UpdateListener {
    ...
    public void update(EventBean[] newData, EventBean[] oldData) {
        ...
        if (countPattern <2){
            ExtractPatternUtil.writePattern(sociabilityPatterns, context, "C:\\Users\\Higo Felipe\\git\\SocialMHealth\\patternsHistory\\currentPattern.json");
    ...
    private double getSimilarity(List<List<Integer>> actualPattern){
        ...
        List<List<Integer>> oldPattern = FileUtil.getCurrentPattern("C:\\Users\\Higo Felipe\\git\\SocialMHealth\\patternsHistory\\currentPattern.json").get(context);
